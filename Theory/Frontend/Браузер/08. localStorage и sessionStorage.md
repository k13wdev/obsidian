...
- Не подходит для больших/структурированных данных → используй [[09. IndexedDB]]
...
- [[07. Cookies]] — альтернатива; cookies отправляются на сервер, Web Storage — нет
- [[09. IndexedDB]] — для больших/структурированных данных; асинхронный
- [[04. Event Loop]] — Web Storage синхронный; блокирует main thread
