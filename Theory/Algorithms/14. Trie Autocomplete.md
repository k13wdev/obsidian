...
- [[05. HashMap]] — альтернатива для поиска слов; Trie добавляет prefix search поверх O(K) сложности
- [[08. Binary Tree DFS]] — автодополнение использует DFS для обхода Trie
- [[18. Backtracking]] — Trie используется для pruning в backtracking алгоритмах
