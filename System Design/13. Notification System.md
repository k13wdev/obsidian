...
- [[07. Очереди сообщений]] — Message Queues для изоляции каналов доставки
- [[12. Rate Limiter]] — ограничение количества уведомлений пользователю
- [[10. Наблюдаемость и надёжность]] — мониторинг доставки, retry, notification log
- [[05. Масштабирование]] — горизонтальное масштабирование Notification Servers
