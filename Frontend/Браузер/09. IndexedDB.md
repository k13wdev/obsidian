...
- [[08. localStorage и sessionStorage]] — более простая альтернатива для небольших строковых данных
- [[07. Cookies]] — для данных, которые нужно передавать на сервер
- [[04. Event Loop]] — асинхронность IndexedDB строится поверх Event Loop; транзакции закрываются по завершении задачи
