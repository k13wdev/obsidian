...
- [[17. Intervals]] — min-heap используется в задаче Meeting Rooms II (отслеживание активных интервалов)
- [[13. Dijkstra]] — использует min-heap для выбора ближайшей вершины
- [[11. Graphs]] — Heap в алгоритмах Prim и Dijkstra для минимального остовного дерева
- [[01. Big-O Notation]] — Build Heap O(n) — классический пример нетривиального анализа
