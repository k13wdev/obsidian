...
- [[06. Heap]] — min-heap используется для задачи Meeting Rooms II (отслеживание окончания встреч)
- [[16. Sliding Window]] — концептуально похожи: отслеживание активного диапазона
- [[01. Big-O Notation]] — сортировка как основа большинства interval алгоритмов O(n log n)
- [[11. Graphs]] — дерево интервалов строится на Red-Black Tree
